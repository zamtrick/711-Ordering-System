  ...
  ({ label, error, leftIcon, rightIcon, className = "", id, ...rest }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <div
          className={[
            "flex items-center h-11 px-3 rounded-xl border bg-white dark:bg-[#121212] gap-2 transition-colors",
            "focus-within:border-[#007A53] dark:focus-within:border-[#078080] focus-within:ring-2 focus-within:ring-[#007A53]/20",
        ...
        >
          ...
          <input
            ...
            id={inputId}
            className={[
              "flex-1 h-full outline-none bg-transparent text-sm text-[#232323] dark:text-white placeholder:text-[#aaa] dark:placeholder:text-[#555]",
              className,
            ].join(" ")}
            {...rest}
          />
